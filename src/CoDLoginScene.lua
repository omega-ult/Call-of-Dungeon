...
function CoDLogin:new()
	...
	ret.loginScene = cc.Scene:create()
	...
	ret.loginScene:addChild(ret.layer )
...
function CoDLogin:getScene()
	return self.loginScene
end

function CoDLogin:getLayer()
	return self.layer
end

function CoDLogin:getLoginButton()
	return self.loginBtn
end

function CoDLogin:getAccountInput()
	return self.accountInput:getText()
end

function CoDLogin:getPasswordInput()
	return self.passwordInput:getText()
end

function CoDLogin:enterLoggingState()
end